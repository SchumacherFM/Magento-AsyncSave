 ...
 */
class SchumacherFM_AsyncSave_Model_Resource_Async extends Mage_Core_Model_Resource_Abstract
{
    ...
    /**
     * @var SchumacherFM_AsyncSave_Model_Db_Adapter_Mysqli
     */
    ...
    /**
     * @return SchumacherFM_AsyncSave_Model_Db_Adapter_Mysqli
     */
    final protected function _getWriteAdapter()
    {
        ...
        $this->_writeAdapter = new SchumacherFM_AsyncSave_Model_Db_Adapter_Mysqli($this->_getCoreReadAdapter()->getConfig());
        return $this->_writeAdapter;
    }
     ...
     * @return $this
     */
    public function raw_query($sql, array $bind = null)
    {
        if (null !== $bind) {
            foreach ($bind as $col => $val) {
                $sql = str_replace(':' . $col, $this->_getWriteAdapter()->escapeValue($val), $sql);
            }
        }
        $this->_lastAsyncResult = $this->_getWriteAdapter()->raw_async_query($sql);
        return $this;
    }
